...
# Nombre - Edad - DNI - Estatura - EstadoCivil
# Convertir estos datos en un Diccionario

class Usuario:
    def __init__(self, Nombre, Edad, Dni, Estatura, ECivil) -> None:
        self.nombre= Nombre
        self.edad = Edad
        self.dni = Dni
...
usuario = Usuario('Christian', 46, 29700824, 1.70, 'Casado')
